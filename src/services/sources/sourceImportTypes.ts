...
export interface SourceImportProgress {
  ...
  message: string;
  filename?: string;
  sourceType?: Extract<SourceType, 'txt' | 'markdown' | 'pasted-text'>;
  byteSize?: number;
}
...
const SAFE_IMPORT_MESSAGES: Record<SourceImportErrorCode, string> = {
  ...
  UNSUPPORTED_FILE_TYPE: 'Choose a TXT, MD, or Markdown file.',
  ...
  UNSUPPORTED_TEXT_SOURCE: 'Only TXT, Markdown, and pasted text are supported here.',

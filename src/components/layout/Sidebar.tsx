...
import { Home, Calendar, Timer, Settings, Zap, Sparkles, Wifi } from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  return (
    <aside className="w-64 shrink-0 bg-[#0B1220] border-r border-white/10 flex flex-col h-screen select-none sticky top-0">
      {/* Brand Header */}
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold tracking-tight text-white font-sans flex items-center gap-1.5">
              Aether
              <span className="text-[10px] font-mono px-1.5 py-0.2 bg-[#4F7CFF]/20 text-[#4F7CFF] rounded border border-[#4F7CFF]/30">Phase 1</span>
            </h1>
      ...
      <div className="px-4 py-3">
        <button
          ...
          className="w-full flex items-center justify-between px-3 py-2 bg-[#111B2E] border border-white/10 hover:border-white/20 rounded-xl text-slate-400 hover:text-slate-200 transition-all text-xs cursor-pointer group"
        >
